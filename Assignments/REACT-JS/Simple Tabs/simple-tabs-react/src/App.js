  ...
  return (
    <div>
      ...
      <div id="tabs">
        <menu>
          <button
            className={contIndex === 0 ? "active" : ""}
            onClick={() => setContIndex(0)}
          >Why React?</button>
          <button
            className={contIndex === 1 ? "active" : ""}
            onClick={() => setContIndex(1)}
          >Core Features</button>
          <button
            className={contIndex === 2 ? "active" : ""}
            onClick={() => setContIndex(2)}
