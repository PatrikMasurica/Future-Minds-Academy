export default function PathToSucces() {
    return (
        <div className="row path-succes-section">
            <div className="col-2">
                <img src="assets/images/trending.png" className="path-img" />
            </div>
            <div className="path-succes">
                <div className="col-2 gap-2">
                    ...
                    <div className="row gap-2">
                        <div className="col-2">
                            <div className="back-hover"><img src="assets/images/reporting.png" alt="Reporting/" />
                            </div>
                        </div>
                        <div className="col-5">
